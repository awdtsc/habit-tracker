...
CREATE TABLE `habit_logs` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_user_habit_date_slot` (`user_id`,`habit_id`,`date`,`time_slot`),
  UNIQUE KEY `habit_logs_habit_date_slot_unique` (`habit_id`,`date`,`time_slot`),
...
CREATE TABLE `habits` (
  ...
  `target_times` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`target_times`)),
...
CREATE TABLE `push_subscriptions` (
  ...
  `subscribable_id` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE `remind_tasks` (
  ...
  `reschedule` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`reschedule`)),
...
-- Dump completed on 2025-11-07 10:53:22
